...
func (mw loggingMiddleware) Sum(ctx context.Context, a int, b int) (v int, err error) {
	defer func() {
...
func (mw loggingMiddleware) Concat(ctx context.Context, a string, b string) (v string, err error) {
	defer func() {
