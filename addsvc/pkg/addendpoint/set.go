...
import (
	...
	"github.com/ThanabutJ/learn-go-kit/addsvc/pkg/addservice"
...
// New returns a Set that wrap the provided server, and wires in all of the
...
func (s Set) Sum(ctx context.Context, a int, b int) (int, error) {
...
func (s Set) Concat(ctx context.Context, a string, b string) (string, error) {
...
// MakeConcatEndpoint constructs a Concate endpoint wrapping the service
